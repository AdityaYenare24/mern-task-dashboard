    ...
    <div className="min-h-screen flex items-center justify-center px-4 page-enter">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#6b7280] mt-1 font-mono">Start managing your tasks</p>
        </div>
        ...
        <div className="card border-[#2a2f3d]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs text-[#6b7280] mb-1.5 uppercase tracking-wider">Name</label>
              <input
                type="text"
                value={form.name}
